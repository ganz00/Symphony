 ...
 */
class Currency extends \Heebari\dataBundle\Entity\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Heebari\\dataBundle\\Entity\\Currency' . "\0" . 'idCurrency', '' . "\0" . 'Heebari\\dataBundle\\Entity\\Currency' . "\0" . 'currency', '' . "\0" . 'Heebari\\dataBundle\\Entity\\Currency' . "\0" . 'currencyCode'];
        }
