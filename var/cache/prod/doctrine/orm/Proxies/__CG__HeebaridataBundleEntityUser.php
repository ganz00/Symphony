 ...
 */
class User extends \Heebari\dataBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'idUser', '' . "\0" . 'Heebari\\dataBundle\\Entity\\User' . "\0" . 'idCountry', '' . "\0" . 'Heebari\\dataBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'Heebari\\dataBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'Heebari\\dataBundle\\Entity\\User' . "\0" . 'birthDate', '' . "\0" . 'Heebari\\dataBundle\\Entity\\User' . "\0" . 'profession', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
