 ...
 */
class CompanyIndustry extends \Heebari\dataBundle\Entity\CompanyIndustry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Heebari\\dataBundle\\Entity\\CompanyIndustry' . "\0" . 'idCompanyIndustry', '' . "\0" . 'Heebari\\dataBundle\\Entity\\CompanyIndustry' . "\0" . 'industryName'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompanyIndustry $proxy) {
    ...
    public function getIdCompanyIndustry()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdCompanyIndustry();
        }
