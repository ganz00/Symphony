 ...
 */
class Collectivity extends \Heebari\dataBundle\Entity\Collectivity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Heebari\\dataBundle\\Entity\\Collectivity' . "\0" . 'idCollectivity', '' . "\0" . 'Heebari\\dataBundle\\Entity\\Collectivity' . "\0" . 'collectivityName', '' . "\0" . 'Heebari\\dataBundle\\Entity\\Collectivity' . "\0" . 'typeCollectivity', '' . "\0" . 'Heebari\\dataBundle\\Entity\\Collectivity' . "\0" . 'idCountry'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Collectivity $proxy) {
    ...
    public function getIdCollectivity()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdCollectivity();
        }
    ...
    public function setCollectivityName($collectivityName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCollectivityName', [$collectivityName]);

        return parent::setCollectivityName($collectivityName);
    }
    ...
    public function getCollectivityName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCollectivityName', []);

        return parent::getCollectivityName();
    }
