...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'heebari_data.country' => 'getHeebariData_CountryService',
            'heebari_data.gestion' => 'getHeebariData_GestionService',
            'heebari_data.keyrecognitor' => 'getHeebariData_KeyrecognitorService',
            'heebari_data.motclef' => 'getHeebariData_MotclefService',
            'heebari_data.user_registration' => 'getHeebariData_UserRegistrationService',
            'heebari_user.registration.form.type' => 'getHeebariUser_Registration_Form_TypeService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HeebaridataBundle', ($this->targetDirs[3].'/app/Resources/HeebaridataBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HeebaridataBundle', ($this->targetDirs[3].'/src/Heebari/dataBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1kdz4nTo4v', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xYRetLXnAs', '', 'BuGtn3FZB52W2VZi0RSmBw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BSADelR3af', '', 'BuGtn3FZB52W2VZi0RSmBw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => $this->get('kernel.class_cache.cache_warmer'), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator.default')), 4 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array(($this->targetDirs[3].'/app/../src/Heebari/dataBundle/Resources/views') => 'template', ($this->targetDirs[3].'/app/../web/bundles/Heebaridata') => 'css')), 6 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, ($this->targetDirs[3].'/app'), array(($this->targetDirs[3].'/app/../src/Heebari/dataBundle/Resources/views') => 'template', ($this->targetDirs[3].'/app/../web/bundles/Heebaridata') => 'css'))), 7 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'base_heebari', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Heebari/dataBundle/Entity'))), 'Heebari\\dataBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('HeebaridataBundle' => 'Heebari\\dataBundle\\Entity'));
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addSubscriberService('heebari_data.user_registration', 'Heebari\\dataBundle\\EventListener\\RegisterListener');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Heebari\\dataBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Heebari\\dataBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'Heebari\\dataBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Heebari\\dataBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Heebari\\dataBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Heebari\\dataBundle\\Entity\\User');
    }
    ...
    /*
     * Gets the 'heebari_data.country' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Heebari\dataBundle\Motcle\countrydata A Heebari\dataBundle\Motcle\countrydata instance
     */
    protected function getHeebariData_CountryService()
    {
        return $this->services['heebari_data.country'] = new \Heebari\dataBundle\Motcle\countrydata($this->get('doctrine.orm.default_entity_manager'), $this->get('heebari_data.motclef'));
    }

    /*
     * Gets the 'heebari_data.gestion' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Heebari\dataBundle\Motcle\gestion A Heebari\dataBundle\Motcle\gestion instance
     */
    protected function getHeebariData_GestionService()
    {
        return $this->services['heebari_data.gestion'] = new \Heebari\dataBundle\Motcle\gestion($this->get('heebari_data.motclef'));
    }

    /*
     * Gets the 'heebari_data.keyrecognitor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Heebari\dataBundle\Motcle\Keyrecognitor A Heebari\dataBundle\Motcle\Keyrecognitor instance
     */
    protected function getHeebariData_KeyrecognitorService()
    {
        return $this->services['heebari_data.keyrecognitor'] = new \Heebari\dataBundle\Motcle\Keyrecognitor($this->get('heebari_data.motclef'));
    }

    /*
     * Gets the 'heebari_data.motclef' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Heebari\dataBundle\Motcle\Gmotcle A Heebari\dataBundle\Motcle\Gmotcle instance
     */
    protected function getHeebariData_MotclefService()
    {
        return $this->services['heebari_data.motclef'] = new \Heebari\dataBundle\Motcle\Gmotcle($this->get('doctrine.orm.default_entity_manager'));
    }

    /*
     * Gets the 'heebari_data.user_registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Heebari\dataBundle\EventListener\RegisterListener A Heebari\dataBundle\EventListener\RegisterListener instance
     */
    protected function getHeebariData_UserRegistrationService()
    {
        return $this->services['heebari_data.user_registration'] = new \Heebari\dataBundle\EventListener\RegisterListener($this->get('router'));
    }

    /*
     * Gets the 'heebari_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Heebari\dataBundle\Form\RegistrationType A Heebari\dataBundle\Form\RegistrationType instance
     */
    protected function getHeebariUser_Registration_Form_TypeService()
    {
        return $this->services['heebari_user.registration.form.type'] = new \Heebari\dataBundle\Form\RegistrationType();
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Heebari');
        ...
        $o = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $n, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($n, 'fos_user_security_login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/login/logout'));
        ...
        $p->setOptions(array('default_target_path' => 'fos_user_profile_show', 'login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($m, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c, $d), 2 => $o, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $this->get('security.authentication.session_strategy'), $n, 'main', $p, $q, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57b82bfc030695.26966765', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $m, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $n, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $n, 'fos_user_security_login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig'), 'paths' => array(($this->targetDirs[3].'/app/../src/Heebari/dataBundle/Resources/views') => 'template', ($this->targetDirs[3].'/app/../web/bundles/Heebaridata') => 'css'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));

        $instance->addExtension(new \Heebari\dataBundle\Twig\AppExtension());
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'AsseticBundle', 4 => 'MonologBundle', 5 => 'SwiftmailerBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'HeebaridataBundle', 9 => 'FOSUserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/app/../src/Heebari/dataBundle/Resources/views'), 'template');
        $instance->addPath(($this->targetDirs[3].'/app/../web/bundles/Heebaridata'), 'css');
        $instance->addPath(($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views'), 'Framework');
        $instance->addPath(($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views'), 'Security');
        $instance->addPath(($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views'), 'Twig');
        $instance->addPath(($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/views'), 'Swiftmailer');
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), 'Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/Heebari/dataBundle/Resources/views'), 'Heebaridata');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fb668b6a6cc00847d1c35fa7f89dde8a322346df');
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4m0GCsFu2w', '', 'BuGtn3FZB52W2VZi0RSmBw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HeebaridataBundle' => 'Heebari\\dataBundle\\HeebaridataBundle',
            ...
            'secret' => 'fb668b6a6cc00847d1c35fa7f89dde8a322346df',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'fb668b6a6cc00847d1c35fa7f89dde8a322346df',
            ...
            'validator.mapping.cache.prefix' => 'validator_9a4443adf7130e062a73ece1675ddb884a07c3e4f0db030b912c9444bc76039d',
            ...
            'fos_user.model.user.class' => 'Heebari\\dataBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'Heebari\\dataBundle\\Form\\RegistrationType',
